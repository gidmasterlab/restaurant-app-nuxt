<template>
	<form class="payment" @submit.prevent="paymentSubmitted">
		...
		<Button model="link" @click="updateDeliveryClicked"> update delivery address </Button>
	</form>
</template>
...
const props = defineProps({ checkoutPayment: Object as PropType<CheckoutPaymentType> });
const emit = defineEmits(["payment-submit", "update-delivery-click"]);
