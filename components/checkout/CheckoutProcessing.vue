<template>
	<div class="processing">
		<div class="header">
			...
			<p class="description" v-if="!processed">Please wait while we process your payment.</p>
...
defineProps({ processed: Boolean });
const emit = defineEmits(["finalize-checkout-click"]);
