<template>
	<div class="product">
		<div class="image">
			<img :src="productImage.asset(product.image)" :alt="product.name" />
		...
		<div class="content">
			<div class="brief">
				...
				<div class="review">
					<ReviewStar :review="Number(review)" v-memo="[review]" />
					<span class="summary">
...
const previousCost: ComputedRef<number> = computed<number>(() => price.getPreviousProductCost(props.product));
const review: ComputedRef<string> = computed<string>(() => format.review(props.product.reviews.totalRating, props.product.reviews.totalReviews))
